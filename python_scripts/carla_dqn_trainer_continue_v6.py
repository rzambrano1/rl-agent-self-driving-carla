...
def main(
    ...
    STATE_DICT_PATH_POLICY = "C:/Users/rzamb/Documents/UMD/642_Robotics/finalProject/state_dict_experiment_4/policy_rgb_ep100.pth"
    STATE_DICT_PATH_TARGET = "C:/Users/rzamb/Documents/UMD/642_Robotics/finalProject/state_dict_experiment_4/target_rgb_ep100.pth"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--EPS_DECAY', default=1000, action='store_true', help="Controls the rate of exponential decay of epsilon, higher means a slower decay") # Ex3 p1 1000
    parser.add_argument('--TAU', default=0.005, action='store_true', help="The update rate of the target network") # Originally 0.005. Then 0.1. Going for a softer update.
